...
(function () {
      ...
      html += `<article class="post-card" data-cat="${post.category}">
        ...
        <div class="post-body" style="padding: 20px; display:flex; flex-direction:column;">
          ...
          <div class="post-footer" style="display:flex; justify-content:space-between; align-items:center; border-top:1px solid #e5e7eb; padding-top:15px; margin-top:auto;">
            ...
            <a href="blog-post.html?id=${post.id}" class="post-readmore" style="color:var(--primary); font-weight:600; text-decoration:none; font-size:14px;">Äá»c Tiáº¿p <i class="fas fa-arrow-right"></i></a>
          </div>
        </div>
      </article>`;
    });
  ...
  if (nlForm) {
    nlForm.addEventListener('submit', e => {
      ...
      btn.innerHTML = '<i class="fas fa-check"></i> ÄÃ£ Ä‘Äƒng kÃ½!';
  ...
  /* â”€â”€ RENDER SIDEBAR POPULAR POSTS â”€â”€ */
